...
import { LayoutDashboard, FileSearch, NotebookPen } from "lucide-react";
...
function RightPanelContent() {
	...
	return <TiptapControls editor={tiptap.editor} />;
}

function LeftPanelContent() {
	return <SidebarNav isCollapsed={false} items={sidebarItems}></SidebarNav>;
}
