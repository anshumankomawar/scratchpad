...
const sheetVariants = cva(
  "fixed mx-2 mb-2 mt-2 z-50 gap-4 bg-background p-3 rounded-md shadow-none border transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
