...
export default function Header({ isRightPanelOpen, setIsRightPanelOpen, isLeftPanelOpen, setIsLeftPanelOpen} : HeaderProps) {
  return (
    <div className="fixed top-0 w-full h-11 bg-transparent border z-10 flex flex-row justify-end" data-tauri-drag-region>
      <div className="flex flex-row p-2">
        <CommandDialogDemo />
        <Button size="custom" variant={"ghost"} onClick={() => setIsLeftPanelOpen(!isLeftPanelOpen)}> 
